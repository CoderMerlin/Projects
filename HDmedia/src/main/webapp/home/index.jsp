  ...
  <div class="hd_culture_info"> <!-- 文化资讯-->
    	<div class="culture_info_container">
            ...
            <div class="figure-info">
            	<ul>
            	 <c:forEach items="${sessionScope.hdIndexInfos }" var="hdIndexInfo">
            	 		
	            	<li class="cul_info_four">
	                     <div>
	                     	<img src="../upload/${hdIndexInfo.wzpicture}" alt="图片加载失败" class="info-img"/>
	                     </div>
	                     <div class="info_introduce"> <!--信息介绍-->
	                         <h4 id="${hdIndexInfo.wzid}">${hdIndexInfo.wzyl1 }</h4>
	                         <p>${hdIndexInfo.wztext}</p>
	                         <button type="button" class="btn re-clr1"><a href="" >详细介绍</a></button>
	                     </div>
	                 </li>
           		 </c:forEach>
                </ul>
