...
<head>
  ...
  <link rel="short icon" href="Hd_index_img/hd_01.png"/>  
                ...
                <div id="invitation-content-b" class="invitation-content-b"><!--帖子内容-->
                	<div class="invitation-content-b-con">  
                    	<div class="invitation-content-b-nav"> 
                            ...
                            <a href="invitation_new.jsp<%-- ?ltid=${sessionScope.ltid } --%>" class="btn b-nav-btn">发表新主题</a>
						    		...
						    		<li id="1001">
		                                ...
		                                <div class="theme_list_con">
		                                	<div class="title">
		                                        ...
		                                        <img class="stamp" src="images/Hd_Community_Forum_img/jin01.png"/>
		                                        <img class="stamp" src="images/Hd_Community_Forum_img/tujian01.png"/>
		                                    </div>
		                                    <div class="auth_msg clearfix">
		                                    	<a href="" class="user_name">${item.yhzsname}</a><!--昵称-->
		                                        <i class="vip_icon"><img src="images/Hd_Community_Forum_img/vip_jpg.jpg" /></i> <!--等级-->
		                                        <span class="time txt">${item.tztime }</span>
		                                        <span class="stick txt">置顶</span>
		                                        <span class="numb view"><!--观看量-->
		                                        	<i><img  src="images/Hd_Community_Forum_img/view.png"/></i>
		                                            <span>1012</span>
		                                        </span>
		                                        <span class="numb msg"><!--回复量-->   
		                                        	<i><img src="images/Hd_Community_Forum_img/msg.png" /></i>
		                                            <span>210</span>
		                                        </span>            
		                                    </div>
		                                </div>
