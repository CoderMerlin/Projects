...
$(function(){
	...
	datagrid=$('#diyu_info').datagrid({   
	    ...
	    columns:[[ 
	        ...
	        {field:'area_id',title:'地域编号',width:100,align:'center',sortable:true},   
	        {field:'area_name',title:'地域名称',width:100,align:'center',editor:{type:"text",options:{required:true}}},
	        {field:'area_title',title:'标题',width:100,align:'center',editor:{type:"text",options:{required:true}}}, 
	        {field:'area_status',title:'状态',width:100,align:'center',sortable:true},
	        {field:'_operate',title:'操作',width:100,align:'center',
	        	formatter: function(value,rowData,index){
	        		//console.info(rowData);
	        		//console.info(JSON.stringify(rowData));
	        		//console.info( JSON.parse(rowData) );
					return '<a class="icon-search1 icon-padding" href="javascript:showdiyuDetail(\''+rowData.area_id+'\')">详细</a>';
				}
			}
	    ]],
	    toolbar:[{
